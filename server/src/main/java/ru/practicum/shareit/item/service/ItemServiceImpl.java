...
public class ItemServiceImpl extends ElementServiceAbs<Item> implements ItemService {
    ...
    public ItemServiceImpl(ItemRepository itemRepository, ItemDtoMapper itemDtoMapper,
                           ItemWithBookingsDtoMapper itemWithBookingsDtoMapper, CommentDtoMapper commentDtoMapper,
                           UserService userService, BookingRepository bookingRepository,
                           CommentRepository commentRepository, ItemRequestService itemRequestService) {
