...
public class BookingServiceImpl extends ElementServiceAbs<Booking> implements BookingService {
    ...
    public BookingServiceImpl(BookingRepository bookingRepository, BookingDtoMapper bookingDtoMapper,
                              BookingWithEntitiesDtoMapper bookingWithEntitiesDtoMapper, ItemService itemService,
