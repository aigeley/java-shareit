...
public class BookingRepositoryCustomImpl implements BookingRepositoryCustom {
    ...
    public BookingRepositoryCustomImpl(@Lazy BookingRepository bookingRepository) {
        ...
        this.stateConditions = new EnumMap<>(BookingState.class);
        this.stateConditions.put(BookingState.CURRENT, bookingIsCurrent());
        this.stateConditions.put(BookingState.PAST, bookingIsPast());
        this.stateConditions.put(BookingState.FUTURE, bookingIsFuture());
        this.stateConditions.put(BookingState.WAITING, bookingStatusIs(BookingStatus.WAITING));
        this.stateConditions.put(BookingState.REJECTED, bookingStatusIs(BookingStatus.REJECTED));
        this.stateConditions.put(BookingState.ALL, null);
    }
